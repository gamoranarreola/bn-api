# Generated by Django 3.2.5 on 2021-08-04 01:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('beautier_profiles', models.ManyToManyField(to='bn_app.BeautierProfile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='bn_app.servicecategory')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='bn_app.StaffingAssignment'),
        ),
        migrations.CreateModel(
